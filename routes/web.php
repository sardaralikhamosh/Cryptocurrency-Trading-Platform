...
use App\Http\Controllers\CryptoChartController;
...
// Crypto Chart Routes
Route::get('/crypto/chart', [CryptoChartController::class, 'index'])->name('crypto.chart');
Route::get('/crypto/data/{coinId?}/{days?}/{currency?}', [CryptoChartController::class, 'getCryptoData'])->name('crypto.data');
